...
nb_images_process = 2              # Set it to -1 for processing all testing images
#path_folder_output = '/Users/chgroc/data/spine_detection/results3D/'
path_folder_output = '/Volumes/data_processing/bdeleener/machine_learning/spine_detection/results3D/'
contrast = 't2'
path_model = '/Users/benjamindeleener/data/machine_learning/results_pipeline_cnn/large/CNN_000015360256_000000_weights'
threshold = 0.8936676383018494          # Set a value (float) or Trial path
