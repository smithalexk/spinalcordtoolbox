...
param_training = {'data_path_local': '/Volumes/data_processing/bdeleener/machine_learning/vsmall_nobrain_nopad/',
                    ...
                    'hyperopt': {'algo':tpe.suggest, 'nb_eval':100, 'fct': roc_auc_score, 'eval_factor': 1, 'ratio_eval':0.25}}
...
coord_prepared_train, label_prepared_train = my_trainer.prepare_patches(my_trainer.fname_training_raw_images, [0.01, 0.01])
