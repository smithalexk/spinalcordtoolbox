...
param_training = {'data_path_local': '/Volumes/data_processing/bdeleener/machine_learning/vsmall_nobrain_nopad/',
                    ...
                    'minibatch_size_train': None, 'minibatch_size_test': 1000, # number for CNN, None for SVM
...
coord_prepared_test, label_prepared_test = my_trainer.prepare_patches(my_trainer.fname_testing_raw_images, [0.01, 0.01])
